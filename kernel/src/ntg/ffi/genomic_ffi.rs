...
#[no_mangle]
pub extern "C" fn ntg_genomic_drop(handle: *mut GenomicHandle) {
    if !handle.is_null() {
        unsafe {
...
#[no_mangle]
pub extern "C" fn ntg_genomic_set(
...
/// Get genotype value
#[no_mangle]
pub extern "C" fn ntg_genomic_get(
...
#[no_mangle]
pub extern "C" fn ntg_genomic_compute_statistics(handle: *mut GenomicHandle) -> i32 {
    if handle.is_null() {
        return -1;
    }
...
/// Get mean for a SNP
#[no_mangle]
pub extern "C" fn ntg_genomic_get_mean(handle: *const GenomicHandle, snp_idx: usize) -> f64 {
    if handle.is_null() {
        return 0.0;
    }
...
#[no_mangle]
pub extern "C" fn ntg_genomic_get_std_dev(handle: *const GenomicHandle, snp_idx: usize) -> f64 {
    if handle.is_null() {
        return 0.0;
    }
...
///
/// # Safety
/// `out` must point to at least (num_snps * num_snps) f64 values.
#[no_mangle]
pub extern "C" fn ntg_genomic_compute_ld(
    handle: *mut GenomicHandle,
    out: *mut f64,
    out_len: usize,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn ntg_genomic_get_ld(
    handle: *mut GenomicHandle,
    snp_i: usize,
    snp_j: usize,
) -> f64 {
...
///
/// # Safety
/// `weights` must point to at least num_snps f64 values.
/// `out` must point to at least num_individuals f64 values.
#[no_mangle]
pub extern "C" fn ntg_genomic_compute_prs(
    handle: *const GenomicHandle,
    weights: *const f64,
    weights_len: usize,
    out: *mut f64,
...
#[no_mangle]
pub extern "C" fn ntg_genomic_num_individuals(handle: *const GenomicHandle) -> usize {
    if handle.is_null() {
        return 0;
    }
...
/// Get number of SNPs
#[no_mangle]
pub extern "C" fn ntg_genomic_num_snps(handle: *const GenomicHandle) -> usize {
    if handle.is_null() {
        return 0;
    }
...
///
/// # Safety
/// `genotypes` must point to (num_snps * num_individuals) u8 values,
/// in row-major order (SNP-major).
#[no_mangle]
pub extern "C" fn ntg_genomic_load_bulk(
    handle: *mut GenomicHandle,
    genotypes: *const u8,
    num_genotypes: usize,
) -> i32 {
...
///
/// # Safety
/// `out` must point to at least (num_snps * num_individuals) u8 values.
#[no_mangle]
pub extern "C" fn ntg_genomic_export_bulk(
    handle: *const GenomicHandle,
    out: *mut u8,
    out_len: usize,
) -> i32 {
